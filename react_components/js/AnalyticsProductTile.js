...
var AnalyticsProductTile = React.createClass({displayName: "AnalyticsProductTile",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {style: tileBgStyle, className: "flex-col h10 flex-grow"}, 
        React.createElement("div", {className: "textWhite ml1 mt1"}, "Product1")
      )
    );
  }
});
